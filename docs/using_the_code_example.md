...
The following example clones the "[UDP-Server](https://github.com/Infineon/mtb-example-psoc-edge-wifi-udp-server)" application with the desired name "UDpServer" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-wifi-udp-server --user-app-name UDpServer --target-dir "C:/mtb_projects"
   ```
